...
st.markdown(
    ...
    **Інструкція для вхідного файлу:**  
    - Файл повинен містити **стовпчик зі SMILES-нотаціями** хімічних сполук: `SMILES`, `Canonical SMILES` або `smiles`.  
    - Можна додати стовпці з дескрипторами, де **перший рядок – назва дескриптора**.  
    - Якщо файл містить лише SMILES, можна обчислити **RdKit дескриптори автоматично** за допомогою кнопки нижче.
    """
)
